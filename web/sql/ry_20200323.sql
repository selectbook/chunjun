...
-- 21、车型机油保养表字段
-- ----------------------------
drop table if exists xt_car_upkeep;
create table xt_car_upkeep (
  id                 int(11)              not null auto_increment          comment '编号',
  first_letter       varchar(5)           default null                     comment '首字母',
  brand              varchar(30)          default null                     comment '品牌',
  series             varchar(60)          default null                     comment '车系',
  series_id          int(11)              default null                     comment '车系id',
  vendor             varchar(60)          default null                     comment '厂商',
  annual             varchar(10)          default null                     comment '年款',
  annual_id          int(11)              default null                     comment '年款id',
  models             varchar(100)         default null                     comment '车型',
  models_id          int(11)              default null                     comment '车型id',
  dosage             varchar(100)         default null                     comment '用量',
  advice             varchar(60)          default null                     comment '建议',
  del_flag           char(1)              default '0'                      comment '删除标志（0代表存在 2代表删除）',
  create_by          varchar(64)          default ''                       comment '创建者',
  create_time 	     datetime                                              comment '创建时间',
  update_by          varchar(64)          default ''                       comment '更新者',
  update_time        datetime                                              comment '更新时间',
  primary key (id)
) engine=innodb auto_increment=1 comment = '车型机油保养表字段';
...
create table xt_device (
  ...
  dept_id            bigint(20)            default null                     comment '部门id',
  dev_name           varchar(60)           default null                     comment '设备名称',
  dev_desc           varchar(100)          default null                     comment '设备描述',
  dev_type           varchar(60)           default null                     comment '设备类型',
  dev_type_id        int(5)                default null                     comment '设备类型id',
  dev_group          varchar(60)           default null                     comment '设备分组',
  dev_group_id       int(5)                default null                     comment '设备分组id',
  dev_code           varchar(60)           default null                     comment '设备编号',
  status             char(1)               default '0'                      comment '设备状态（0初始值 1正常 2离线 3故障）',
  oil_code           varchar(60)           default null                     comment '油桶编号',
  bind_dept_id       bigint(20)            default null                     comment '绑定部门id',
  bind_time 	       datetime                                               comment '绑定时间',
  register           char(1)               default '0'                      comment '注册状态（0未注册 1已注册）',
  register_time      datetime                                               comment '注册时间',
  work_mod           char(1)               default '1'                      comment '工作模式（1基本模式 2汽修店模式 3油厂模式）',
  ...
  update_time        datetime                                               comment '更新时间',
  primary key (id)
) engine=innodb auto_increment=1 comment = '设备表字段';

-- ----------------------------
-- 23、设备定位表字段
-- ----------------------------
drop table if exists xt_device_position;
create table xt_device_position (
  id                 bigint(20)            not null auto_increment          comment '编号',
  device_code        varchar(60)           default null                     comment '设备编号',
  ipaddr             varchar(50)           default null                     comment '设备IP地址',
  latitude           varchar(20)           default null                     comment '定位纬度',
  longitude          varchar(20)           default null                     comment '定位经度',
  gps_time 	         datetime                                               comment '定位时间',
  province           varchar(20)           default null                     comment '所在省份',
  city               varchar(30)           default null                     comment '所在城市',
  address            varchar(255)          default null                     comment '详细地址',
  del_flag           char(1)               default '0'                      comment '删除标志（0代表存在 2代表删除）',
  ...
  update_time        datetime                                               comment '更新时间',
  primary key (id)
) engine=innodb auto_increment=1 comment = '设备定位表字段';

-- ----------------------------
-- 24、油桶表字段
-- ----------------------------
drop table if exists xt_oil_drum;
create table xt_oil_drum (
  id                 bigint(20)            not null auto_increment          comment '编号',
  dept_id            bigint(20)            default null                     comment '部门id',
  oil_code           varchar(60)           default null                     comment '油桶编号',
  oil_name           varchar(50)           default null                     comment '油品名称',
  vendor             varchar(60)           default null                     comment '品牌厂商',
  tank_capacity      double(11,6)          default null                     comment '油桶容量(l)',
  remain_amount      double(11,6)          default null                     comment '油桶余量(l)',
  bind_dept_id       bigint(20)            default null                     comment '绑定部门id',
  bind_time 	       datetime                                               comment '绑定时间',
  del_flag           char(1)               default '0'                      comment '删除标志（0代表存在 2代表删除）',
  create_by          varchar(64)           default ''                       comment '创建者',
  ...
  update_time        datetime                                               comment '更新时间',
  primary key (id)
) engine=innodb auto_increment=1 comment = '油桶表字段';


-- ----------------------------
-- 25、机油加注表字段
-- ----------------------------
drop table if exists xt_oil_fill;
create table xt_oil_fill (
  id                 bigint(20)            not null auto_increment          comment '编号',
  dev_code           varchar(60)           default null                     comment '终端编号',
  work_mod           char(1)               default '1'                      comment '工作模式（1基本模式 2汽修店模式 3油厂模式）',
  setting_amount     double(11,6)          default null                     comment '设定加注量',
  current_amount     double(11,6)          default null                     comment '当前加注量',
  total_amount       double(11,6)          default null                     comment '总加注量',
  tank_capacity      double(11,6)          default null                     comment '油桶容量',
  remain_amount      double(11,6)          default null                     comment '油桶余量',
  dev_status         char(1)               default '0'                      comment '终端状态（0初始值 1正常 2离线 3故障）',
  ipaddr             varchar(50)           default null                     comment '终端IP地址',
  local_time 	       datetime                                               comment '终端时间',
  create_time 	     datetime                                               comment '创建时间',
  primary key (id)
) engine=innodb auto_increment=1 comment = '机油加注表';
