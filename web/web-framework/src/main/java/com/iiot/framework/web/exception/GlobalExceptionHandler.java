package com.iiot.framework.web.exception;
...
import com.iiot.common.exception.DemoModeException;
...
public class GlobalExceptionHandler {
    ...
    public RestResp appException(ApiException e) {
        log.error("API业务异常,异常信息为: {}", e.getMessage());
