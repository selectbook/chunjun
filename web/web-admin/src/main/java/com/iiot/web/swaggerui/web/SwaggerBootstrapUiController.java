package com.iiot.web.swaggerui.web;

import com.google.common.base.Optional;
import com.google.common.base.Strings;
import com.google.common.collect.Lists;
import com.iiot.common.constant.Constants;
import com.iiot.web.swaggerui.model.RestHandlerMapping;
import com.iiot.web.swaggerui.models.SwaggerBootstrapUi;
import com.iiot.web.swaggerui.models.SwaggerBootstrapUiPath;
import com.iiot.web.swaggerui.models.SwaggerBootstrapUiTag;
import com.iiot.web.swaggerui.models.SwaggerExt;
...
public class SwaggerBootstrapUiController {
    ...
    private void initGlobalHandlerMappings(SwaggerExt swaggerExt, WebApplicationContext wc) {
        if (globalHandlerMappings.size() == 0) {
            ...
            String parentPath = "";
            //判断basePath
            if (!StringUtils.isEmpty(swaggerExt.getBasePath()) && !Constants.SLASH.equals(swaggerExt.getBasePath())) {
