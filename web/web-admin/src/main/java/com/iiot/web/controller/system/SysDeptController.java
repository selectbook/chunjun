...
public class SysDeptController extends BaseController {
    ...
    @GetMapping("/treeData")
    @ResponseBody
    public List<Ztree> treeDataDevice() {
        List<Ztree> ztrees = deptService.selectDeptTree(new SysDept(), 1);
        return ztrees;
    }
     ...
     * 加载部门列表树油桶
     */
    @GetMapping("/treeDataDrum")
    @ResponseBody
    public List<Ztree> treeDataDrum() {
        List<Ztree> ztrees = deptService.selectDeptTree(new SysDept(), 2);
        return ztrees;
    }
